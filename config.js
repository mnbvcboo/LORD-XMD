...
BOT_NAME: process.env.BOT_NAME || "𝙻𝙾𝚁𝙳 𝚇𝙼𝙳",
...
///===========Do not change anything below !!ALIVE-CONFIG==============
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/ug2x1y.jpg", //do not change img url
ALIVE_MSG: process.env.ALIVE_MSG || "ʜɪ ᴀᴍ ᴀʟɪᴠᴇ ɴᴏᴡ ᴀᴍ ʟᴏʀᴅ xᴍᴅ ᴛʜᴇ ʙᴇsᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ", //add alive msg
};
